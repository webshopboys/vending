{if $status == 'ok'}
	<p>{l s='Your order on' mod='paypalapi'} <span class="bold">{$shop_name}</span> {l s='is complete.' mod='paypalapi'}
		...
		<br /><br />{l s='For any questions or for further information, please contact our' mod='paypalapi'} <a href="{$base_dir_ssl}contact-form.php">{l s='customer support' mod='cheque'}</a>.
	</p>
