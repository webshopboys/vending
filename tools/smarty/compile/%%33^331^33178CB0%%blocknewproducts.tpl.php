<?php /* Smarty version 2.6.20, created on 2012-05-16 00:19:36
         compiled from /web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl', 3, false),array('function', 't', '/web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl', 29, false),array('modifier', 'count', '/web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl', 5, false),array('modifier', 'escape', '/web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl', 12, false),array('modifier', 'strip_tags', '/web/vendingoutlet/vendingoutlet.org/modules/blocknewproducts/blocknewproducts.tpl', 28, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['new_products']['0']['reserved'] > 0 && $this->_tpl_vars['new_products']['0']['reserved'] >= $this->_tpl_vars['new_products']['0']['quantity']): ?>
<?php $this->assign('isReserved0', 1); ?>
<?php else: ?>
<?php $this->assign('isReserved0', 0); ?>
<?php endif; ?>
...
" <?php if ($this->_tpl_vars['isReserved0']): ?>class="reserved"<?php endif; ?>/>
			</a></li>
			<?php if (count($this->_tpl_vars['new_products']) > 1): ?>
<?php if ($this->_tpl_vars['new_products']['1']['reserved'] > 0 && $this->_tpl_vars['new_products']['1']['reserved'] >= $this->_tpl_vars['new_products']['1']['quantity']): ?>
<?php $this->assign('isReserved1', 1); ?>
<?php else: ?>
<?php $this->assign('isReserved1', 0); ?>
<?php endif; ?>			
...
" <?php if ($this->_tpl_vars['isReserved1']): ?>class="reserved"<?php endif; ?>/>
			</a></li>
			<?php endif; ?>
		</ul>
		<dl class="products">
