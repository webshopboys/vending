...
" 
				<?php if ($this->_tpl_vars['jqZoomEnabled']): ?>
				class="jqzoom<?php if ($this->_tpl_vars['isReserved']): ?> reserved<?php endif; ?>" alt="<?php echo $this->_tpl_vars['link']->getImageLink($this->_tpl_vars['product']->link_rewrite,$this->_tpl_vars['cover']['id_image'],'thickbox'); ?>
"
				<?php else: ?> 
...
" <?php if ($this->_tpl_vars['isReserved']): ?>class="reserved"<?php endif; ?>/>
		...
		<p><a href="http://www.vendingoutlet.org/img/p/<?php echo $this->_tpl_vars['cover']['id_image']; ?>
.jpg" title='Kattints a jobb egérgombbal, majd Hivatkozás mentése más néven...'><b>Nagy méretű kép letöltése</b></a> <br /> 
		<a href="http://www.vendingoutlet.org/img/p/<?php echo $this->_tpl_vars['cover']['id_image']; ?>
.jpg" title='Right click, Save target as...'><b>Download high resolution image</b></a></p>	
		<?php endif; ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['packItem']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
		...
		<?php if ($this->_tpl_vars['product']->description): ?>
			<!-- full description -->
			<div class="extra_block"><?php echo $this->_tpl_vars['product']->description; ?>
</div>
		<?php endif; ?>
...
<?php endif; ?>
			...
			<p><span <?php if (((is_array($_tmp=$this->_tpl_vars['product']->reserved)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)) > 0): ?>class="price-wrapping"<?php endif; ?>>
			<?php echo smartyTranslate(array('s' => 'Reserved'), $this);?>
:&nbsp;&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['product']->reserved)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
&nbsp;<?php echo smartyTranslate(array('s' => 'item'), $this);?>

			</span></p>
			<?php if (((is_array($_tmp=$this->_tpl_vars['product']->reserved)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)) > 0): ?> <!-- only if reserved view date -->
			<p><span class="price-wrapping">
			<?php echo smartyTranslate(array('s' => 'Reserve date'), $this);?>
:&nbsp;&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['product']->reserved_date)) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
...
<?php endif; ?>
		...
		<?php if ($this->_tpl_vars['product']->supplier_reference && $this->_tpl_vars['product']->location): ?>
			<div id='stock-price'>
				<table width='216'>
				<tr><td width='108'><p><b><?php echo smartyTranslate(array('s' => 'Stock (pieces)'), $this);?>
</b></p></td><td width='108'><p><b><?php echo smartyTranslate(array('s' => 'Price (€)'), $this);?>
</b></p></td></tr>
				<tr><td><p><?php echo $this->_tpl_vars['product']->supplier_reference; ?>
</p></td><td><p><?php echo $this->_tpl_vars['product']->location; ?>
</p></td></tr>
				</table>
			</div><!-- stock-price -->
		<?php endif; ?>
