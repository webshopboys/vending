<?php /* Smarty version 2.6.20, created on 2012-05-16 06:16:41
         compiled from /web/vendingoutlet/vendingoutlet.org/themes/prestashop/authentication.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/authentication.tpl', 1, false),array('modifier', 'intval', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/authentication.tpl', 6, false),array('modifier', 'escape', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/authentication.tpl', 12, false),array('modifier', 'stripslashes', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/authentication.tpl', 41, false),)), $this); ?>
...
&nbsp;&nbsp;</option>
			...
			<p class="checkbox" >
				<input type="checkbox" name="newsletter" id="newsletter" value="1" <?php if (isset ( $_POST['newsletter'] ) && ( $_POST['newsletter'] == 1 || $_POST['newsletter'] == 3 )): ?> checked="checked"<?php endif; ?> />
				<label for="newsletter"><?php echo smartyTranslate(array('s' => 'Sign up for our newsletter'), $this);?>
</label>
			</p>

			<p class="checkbox">
				<input type="checkbox" id="newproduct" name="newproduct" value="1" <?php if ($_POST['newsletter'] == 2 || $_POST['newsletter'] == 3): ?> checked="checked"<?php endif; ?> />
				<label for="newproduct"><?php echo smartyTranslate(array('s' => 'Sign up for new product alert'), $this);?>
</label>
			</p>
			<p class="checkbox" >
