...
" />
<?php endif; ?>
<?php if (isset ( $this->_tpl_vars['tags'] ) && $this->_tpl_vars['tags']): ?>
		<meta name="keywords" content="kávéautomata, webshop, használt, <?php $_from = $this->_tpl_vars['tags']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['myLoop'] = array('total' => count($_from), 'iteration' => 0);
...
js/jquery/jquery.hotkeys-0.7.8-packed.js"></script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['content_dir']; ?>
js/jquery/jquery-watermarker.js"></script>
		<?php if ($this->_tpl_vars['page_name'] == 'index'): ?>
			<script type="text/javascript" src="<?php echo $this->_tpl_vars['content_dir']; ?>
js/popup/popup.js"></script>
			<link rel="stylesheet" href="<?php echo $this->_tpl_vars['content_dir']; ?>
js/popup/general.css" type="text/css" media="screen" />
		<?php endif; ?>
