<?php /* Smarty version 2.6.20, created on 2013-02-11 17:51:03
         compiled from /web/vendingoutlet/vendingoutlet.org/themes/prestashop/addresses.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/addresses.tpl', 7, false),array('modifier', 'intval', '/web/vendingoutlet/vendingoutlet.org/themes/prestashop/addresses.tpl', 32, false),)), $this); ?>
...
?>
	<ul class="address <?php if (($this->_foreach['myLoop']['iteration'] == $this->_foreach['myLoop']['total'])): ?>last_item<?php elseif (($this->_foreach['myLoop']['iteration'] <= 1)): ?>first_item<?php endif; ?> <?php if (($this->_foreach['myLoop']['iteration']-1) % 2): ?>alternate_item<?php else: ?>item<?php endif; ?>">
		...
		<li class="address_company"><?php echo $this->_tpl_vars['address']['eu_account']; ?>
</li>
		<?php endif; ?>
